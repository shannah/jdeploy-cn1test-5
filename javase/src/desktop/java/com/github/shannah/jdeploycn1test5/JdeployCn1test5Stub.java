 ...
 * @author Shai Almog
 */
public class JdeployCn1test5Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Jdeploy Cn1test 5";
    private static final String APP_NAME = "jdeploy-cn1test-5";
    ...
    private JdeployCn1test5 mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new JdeployCn1test5Stub());
    }
